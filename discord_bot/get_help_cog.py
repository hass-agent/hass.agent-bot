...
class GetHelpCog(commands.Cog):
    ...
    async def on_thread_create(self, thread):
        ...
        if thread.parent.id == self.help_channel_id:
            ...
            if "hass.agent setup" in tags or "hass automations" in tags:
                users_to_ping.add(638245963240046592)

            # Send Embeds
            await thread.send(embed=mark_solution_embed, file=nextcord.File("mark_solution.png"))
